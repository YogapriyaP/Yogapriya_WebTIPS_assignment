...
function ChangeTimeline(val) {
  ...
  let two = (document.getElementById('onehour').innerHTML =
    mydata[val].nextFiveHrs[1]);
  let three = (document.getElementById('onehour').innerHTML =
    mydata[val].nextFiveHrs[2]);
  let four = (document.getElementById('onehour').innerHTML =
